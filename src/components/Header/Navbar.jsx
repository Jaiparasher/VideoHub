...
function Navbar() {
  ...
  const profileImg = useSelector((state) => state.auth.userData?.data?.avatar.url);
  ...
  return (
    <>
      <nav className="w-full h-[10vh] bg-[#393E46] flex justify-between items-center p-4 sm:gap-5 gap-2 border-b-2 border-gray-500 sticky top-0 z-50">
        ...
        {toggleMenu && (
          <div className="fixed right-0 top-0 text-white flex flex-col border-l h-[90vh]  w-5/6 bg-[#393E46] sm:hidden rounded-lg outline-none">
